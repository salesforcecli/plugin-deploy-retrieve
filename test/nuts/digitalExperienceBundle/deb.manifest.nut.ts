...
describe('deb -- manifest option', () => {
  ...
  describe('deploy', () => {
    ...
    describe('individual metadata item', () => {
      it('should deploy all de components of deb_a', async () => {
        const deployedSource = await deployWithRetry(
    ...
    describe('through generated manifests', () => {
      it('should deploy all debs using the manifest generated by sourcepath', async () => {
        const deployedSource = await deployWithRetry(
      ...
      it('should deploy all debs using the manifest generated by metadata', async () => {
        const deployedSource = await deployWithRetry(
