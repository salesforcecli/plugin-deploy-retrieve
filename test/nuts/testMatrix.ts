...
const testRepos: RepoConfig[] = [
  {
    ...
    deploy: {
      sourceDir: [
        ...
        {
          toDeploy: ['force-app/main/default/objects'],
          toVerify: ['force-app/main/default/objects/**/*'],
        },
        {
          toDeploy: ['my-app/apex/my.cls-meta.xml'],
...
export type RepoConfig = {
  ...
  convert: {
    ...
    sourceDir: ConvertTestCase[];
    manifest: ConvertTestCase[];
  };
};

type DeployTestCase = {
  toDeploy: string[]; // the string to be passed into the deploy:metadata command execution. Do not include the flag name (e.g. --sourceDir)
...
type RetrieveTestCase = {
  toRetrieve: string; // the string to be passed into the retrieve:metadata command execution. Do not include the flag name (e.g. --sourceDir)
...
type ConvertTestCase = {
  toConvert: string; // the string to be passed into the source:convert command execution. Do not include the flag name (e.g. --sourceDir)
